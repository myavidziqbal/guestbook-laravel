...
<head>
  ...
  <title>Admin Dashboard | KIG</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/" class="brand-link">
      <img src="{{asset('template/dist/img/new_logoKIG.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light"><h3>MIS</h3></span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{asset('template/dist/img/user-login.jpg')}}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/logout" class="nav-link">
              {{-- <i class="nav-icon fas fa-th"></i> --}}
              <i class="nav-icon fas fa-chevron-right" aria-hidden="true"></i>
              <p>
                Logout
              </p>
            </a>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2021 <a href="https://adminlte.io">Koyota International Group</a>.</strong>
    All rights reserved.
